...
export default function TeamMember() {
    ...
    const data = [
        {name:"Gamandeep Singh" , domain:"Frontned Developer" ,img:"https://wallpapers.com/images/hd/cool-profile-picture-87h46gcobjl5e4xu.jpg"},               
        {name:"Gamandeep Singh" , domain:"Frontned Developer" ,img:"https://wallpapers.com/images/hd/cool-profile-picture-87h46gcobjl5e4xu.jpg"},               
        {name:"Gamandeep Singh" , domain:"Frontned Developer" ,img:"https://wallpapers.com/images/hd/cool-profile-picture-87h46gcobjl5e4xu.jpg"},    
        {name:"Gamandeep Singh" , domain:"Frontned Developer" ,img:"https://wallpapers.com/images/hd/cool-profile-picture-87h46gcobjl5e4xu.jpg"},    
    ]
  return (
    <div className='w-full max-w-[1080px]  overflow-x-hidden flex flex-col justify-center items-center mx-2 mb-[20vh]'>
       <h1 className='text-[6vh] font-[repo-extrabold] text-white underline mt-2 mb-[10vh]'>Team Members</h1>
